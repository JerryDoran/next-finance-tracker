...
function CategoryCard({ category }: { category: Category }) {
  return (
    <div className='flex flex-col border-separate justify-between rounded-md border shadow-md shadow-black/[.1] dark:shadow-white/[.1]'>
      ...
      <DeleteCategoryDialog
        ...
        trigger={
          <Button
            className='flex w-full border-separate items-center gap-2 rounded-t-none text-muted-foreground transition hover:bg-red-500/20'
            variant='secondary'
          >
